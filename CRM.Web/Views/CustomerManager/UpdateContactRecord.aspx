...
<head runat="server">
    <title>UpdateContactRecord</title>
...
<body>
    <!--标题部分-->
    <div id="divTitle">
        <span class="title"><a href='<%=Url.Action("Index") %>'>客户信息管理</a>&nbsp;>>&nbsp;交往记录修改</span><br />
        <hr />
    </div>
    <div id="divTitleH">
    </div>
    ...
    <div id="divControlEnd">
        ...
        <input type="button" onclick=javascript:window.location.href='<%=Url.Action("ContactRecord",new{id=Model.cst_customer.cust_Id}) %>'; value="返回" class="transparent button" />
    </div>
    <%Html.EndForm(); %>
</body>
</html>
