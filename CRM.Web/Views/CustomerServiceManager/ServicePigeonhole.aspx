...
<body>
    <!--标题部分-->
    <div id="divTitle">
        <span class="title">客户服务归档</span><br />
        <hr />
    </div>
    <div id="divTitleH">
    </div>
    <!--标题部分结束-->
    <%Html.BeginForm("ServicePigeonhole", "CustomerServiceManager", FormMethod.Post, new { id = "form1" }); %>
    <!--表头操作部分-->
    <div id="divListTop">
    ...
    <div id="divList">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="tblItem">
                ...
                <td>
                    <a href='<%=Url.Action("CustomerServiceInfo") %>/<%=Html.Encode(item.svr_id) %>'>
                        <img src="../../Images/ico/bt_detail.gif" title="查看详细"  class="imgLink" />
                    </a>
                </td>
            </tr>
            <%
