...
<head runat="server">
    <title>CustomerServiceInfo</title>
...
<body>
    <!--标题部分-->
    <div id="divTitle">
        <span class="title">客户服务归档详细</span><br />
        <hr />
    </div>
    <div id="divTitleH">
    </div>
    ...
    <div class="divTable2">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <%=Html.Encode(Model.svr_deal_date) %>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="divControlEnd">
        <input type="button" onclick=javascript:window.location.href='<%=Url.Action("ServicePigeonhole") %>'; value="返回" class="transparent button" />
    </div>
    <%Html.EndForm(); %>
</body>
</html>
