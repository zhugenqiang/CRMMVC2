...
<head runat="server">
    <title>ServiceFeedbacking</title>
...
<body>
    <!--标题部分-->
    <div id="divTitle">
        <span class="title">客户服务反馈</span><br />
        <hr />
    </div>
    <div id="divTitleH">
    </div>
    ...
    <div class="divTable2">
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td colspan="3">
                    <textarea name="svr_deal" disabled="disabled"><%=Model.svr_deal %></textarea>
    ...
    <div class="divTable2">
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <input name="svr_result" value='<%=Model.svr_result %>' type="text" class="text" />
                </td>
                <th>
                    满意度:
                </th>
                <td>
                    <%=Html.DropDownList("svr_satisfy", ViewData["satisfy"] as SelectList,"--请选择--")%>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="divControlEnd">
        ...
        <input type="button" onclick=javascript:window.location.href='<%=Url.Action("ServiceFeedback") %>'; value="返回" class="transparent button" />
    </div>
    <%Html.EndForm(); %>
</body>
</html>